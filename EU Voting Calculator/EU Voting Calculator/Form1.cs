...
namespace EU_Voting_Calculator
{
    public partial class Form1 : Form
    {
        Loader loader;
        VotingCount vote;
        public Form1(ref Loader _loader , ref VotingCount _vote)
        {
            InitializeComponent();
            loader = _loader;
            vote = _vote;
...
//<<<<<<< HEAD
        ...
        {
            //BELGIUM ABSTAIN
            loader.countryList[1].setVote(2);
        }

        private void button7_Click(object sender, EventArgs e)
        {
            //BULGARIA YES
            loader.countryList[2].setVote(0);
        }

        private void button8_Click(object sender, EventArgs e)
        {
            //BULGARIA NO
            loader.countryList[2].setVote(1);
        }
        ...
        private void checkedListBox2_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (iSelectedIndex == 0)
                vote.rule = "Qualified Majority";
            if (iSelectedIndex == 1)
                vote.rule = "Reinforced Qualified Majority";
            if (iSelectedIndex == 2)
                vote.rule = "Simple Majority";
            if (iSelectedIndex == 3)
                vote.rule = "Unanimity";
